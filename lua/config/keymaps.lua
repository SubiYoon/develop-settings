...
mapKey("<Leader>dq", function()
	require("dap").terminate()
end, "n", { desc = "Terminate" })
mapKey("<Leader>dbm", function()
	require("dap").set_breakpoint(nil, nil, vim.fn.input("Log point message: "))
end, "n", { desc = "Debug: Set log point" })
mapKey("<Leader>dro", function()
	require("dap").repl.open()
end, "n", { desc = "Open debug REPL" })
mapKey("<Leader>drl", function()
	require("dap").run_last()
end, "n", { desc = "Run last debug session" })
mapKey("<Leader>dh", function()
	require("dap.ui.widgets").hover()
end, { "n", "v" }, { desc = "Hover" })
mapKey("<Leader>dp", function()
	require("dap.ui.widgets").preview()
end, { "n", "v" }, { desc = "Preview" })
